...
const addToForm = document.getElementById('addToDo')
...
const editBtn = document.getElementById('editToBtn')
...
const addListItem = (item) => {
  ...
  const parent = item.checked ? completeToDo : incompleteToDo

  parent.appendChild(wrapper)
  listCheck.addEventListener('click', (event) => {
    if (event.target.checked) {
      completeToDo.appendChild(wrapper)
